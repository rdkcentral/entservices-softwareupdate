...
############################
# Build entservices-maintenancemanager
echo "======================================================================================"
echo "buliding entservices-maintenancemanager"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-maintenancemanager \
-DUSE_THUNDER_R4=ON \
...
cmake --build build/entservices-maintenancemanager --target install
echo "======================================================================================"
exit 0

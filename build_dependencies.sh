...
git clone --branch "${CURRENT_BRANCH}" https://github.com/rdkcentral/entservices-apis.git || git clone --branch main https://github.com/rdkcentral/entservices-apis.git
